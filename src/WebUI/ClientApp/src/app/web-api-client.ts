...
export class MovieClient implements IMovieClient {
    ...
    getMovieInfo(path: string | null | undefined): Observable<MovieVm> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetMovieInfo(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetMovieInfo(<any>response_);
                } catch (e) {
                    return <Observable<MovieVm>><any>_observableThrow(e);
                }
            } else
                return <Observable<MovieVm>><any>_observableThrow(response_);
        }));
    }

    protected processGetMovieInfo(response: HttpResponseBase): Observable<MovieVm> {
